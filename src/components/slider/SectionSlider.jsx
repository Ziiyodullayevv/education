...
const SectionSlider = memo(
  ({
    ...
    return (
      <div style={{ marginTop: "100px" }} className={className}>
        <Container fluid>
          <div
            className={`overflow-hidden ${
              cardClass ? "card-style-slider" : ""
            }`}
            ref={slider}
          >
            <div
              className={`d-flex align-items-center justify-content-between px-md-3 px-1 mb-4 ${paddingY}`}
            >
